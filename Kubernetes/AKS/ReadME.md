...
Azure DevOps for Kubernetes Workloads running on Azure AKS Cluster: 
...
Presentation with 250 Slides outlining the various architectures and designs we are going to do in this course: 
